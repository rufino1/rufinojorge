var PEDIDO = (function () {
    ...
    my.crearEnlaces=function(){
        //Enlaces Page Alumno
     $("body").append('<a id="idpageconfirmar" href="#pageconfirmar"  class="style-31"></a>');  
     
    };//////////////////////////////////////////////////////////////////////////////////
	my.onClickpedido = function () {
		 /* your code goes here */
        var opciones=$("#idplatos :checked")[0].id;
        if(opciones=="idEscogerAlumno_Notas"){
            ...
            var param={};
            param.idAlumno=GLOBAL_PEDIDO.getIdentificador();
            param.idCurso=idCurso;    
            UTILS.ajaxGeneric(param,"getDetalle",function(data){
    ...
    */
    function getPedidos(idUsuario,callback){
        
        var param={};
        param.idUsuario=idUsuario;    
        UTILS.ajaxGeneric(param,"getPedidos",callback);
        
    }/////////////////////////////////////////////////////////////////////////////////
    my.cargarPedidos=function(idUsuario){
        
        getPedidos(idUsuario,function(data){
